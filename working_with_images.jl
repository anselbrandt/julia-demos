...
# ╔═╡ fdbe8bfa-07df-11ed-3123-87a7c9931953
using Images, Statistics, Markdown

# ╔═╡ 4cde134c-a139-4beb-b450-48422e77b668
url="https://anselbrandt.github.io/assets/cat.jpg"

# ╔═╡ bebd8335-8ce3-4002-ba76-622767eb0c18
download(url,"cat.jpg")

# ╔═╡ 4b7a81e4-750f-4d5f-9d01-b6c3d8a34f74
image=load("cat.jpg")

# ╔═╡ b79ba5a3-1706-401c-afab-f07dab07ad7c
typeof(image)

# ╔═╡ f2ffdd47-272a-45dc-86b7-5e05150f732a
size(image)

# ╔═╡ ff8021ac-4d27-469d-a7b3-e07dc26a986b
# get raw pixel values
# (rawview ∘ channelview)(image)

# ╔═╡ 966962eb-7c88-4681-ada3-3140765406df
md"""
# Function definitions
"""

# ╔═╡ e9d86c5a-c509-454f-920e-c791dbc71817
kernel = Kernel.gaussian((2,2))

# ╔═╡ 62a15969-2f8e-4aea-87a2-4671cabb7b54
# sharpen
kernel2 = centered([
	-.5 -1.0 -.5
	-1.0 7.0 -1.0
...
# ╔═╡ cb1551ad-369c-4ecb-b49a-95788940337c
...
# ╔═╡ 9f10277c-22a1-44dd-aa18-9af9f5af9d2a
...
# ╔═╡ badbb77f-2777-457b-a6e0-835dccc5dc52
conv_image = convolve(image, kernel)

# ╔═╡ 158929d9-eae8-4cdc-b240-bdc07c86cc83
function resize_image(image, ratio=5)
...
# ╔═╡ 8ad52aa9-f392-4959-a410-8b1d0777ef98
resized = resize_image(image,1)

# ╔═╡ 39b7fe6c-690f-4189-a6ce-5b464a2d004e
conv_image_2 = convolve(resized, kernel2)
